...
const About = () => {
    ...
    return (
        <>
            <div className='MainDiv' style={{ width: "700px" }}>
                <div className='container my-3' style={myStyle}>
                    <h1 className='my-3' style={{ fontSize: "50px" }}>😍 Kids General Knowledge 😍</h1>
                    <div className="d-sm-flex align-items-center justify-content-between w-20" style={{ height: "50vh", marginTop: "25px" }}>
                        <div className="col-md-4 my-3 mx-auto mb-4 mb-sm-0 headline">
                            <span className="text-secondary text-uppercase"><span style={{ color: "green", fontSize: "30px" }}>🆂🅿🅴🅲🅸🅰🅻 🅵🅾🆁</span></span>
                            <h1 className="display-4 my-4 font-weight-bold color-red"> <span style={{ color: "#9B5DE5", strong: "700", fontSize: "35px" }}>✌Divisa,Ojas and Gajraj Kids✌</span></h1>
                        ...
                        <div className="col-md-8 h-100 clipped" style={{ minHeight: "200px", width: "450px", backgroundImage: "url(Photo.jpg)", backgroundPosition: "center", backgroundSize: "cover", borderRadius: "10px" }}>
